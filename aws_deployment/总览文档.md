...
| 文件名 | 用途 | 何时使用 |
|--------|------|---------|
| **完成总结.md** | 项目完成总结（中文） | 首先阅读这个！ |
| **部署指南_详细版.md** | 完整部署指南（详细版，中文） | 需要了解每个步骤的详细说明时 |
| **快速开始指南.md** | 快速开始指南（精简版，中文） | 想要快速上手，一步步跟着做 |
| **演示指南.md** | 演示准备指南（中文） | 准备 PPT 和演示时 |
| **总览文档.md** | 本文件（中文） | 了解文件夹结构 |
...
| **upload_to_s3.bat** | S3 上传工具（Windows） | 自动上传数据到 S3 |
